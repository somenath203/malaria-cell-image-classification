...
zip_path = 'alexnet_model.zip'

extract_dir = 'alexnet_model'
...
model = load_model(os.path.join(extract_dir, 'alexnet_model'))
...
def welcome():
    return {
        'success': True,
        'message': 'server of "malaria cell prediction" is up and running successfully.'
    }
